...
## Phase 0 — Conception
The idea for CastQuest emerged from the need for a sovereign, media‑first
automation protocol that could unify frames, quests, mints, and strategy into a
single expressive pipeline.
