...
import "./globals.css";
import { NeoThemeProvider } from "@castquest/neo-ux-core";
import { AuthSessionProvider } from "../components/providers/SessionProvider";
import { Web3Provider } from "../components/providers/Web3Provider";

export const metadata = {
  title: "CastQuest | Decentralized Protocol Universe",
  description: "Create, Cast, and Conquer in the Sovereign Web3 Media Hub. Powered by Farcaster, Zora, Solana, and BASE.",
};
            ...
            <nav className="fixed top-0 left-0 right-0 z-50 border-b border-neutral-800 bg-black/80 backdrop-blur-sm">
              <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <a
                    href="/login"
                    className="px-4 py-2 text-sm font-semibold rounded-lg bg-gradient-to-r from-purple-500/20 to-cyan-500/20 border border-emerald-500/30 text-emerald-400 hover:from-purple-500/30 hover:to-cyan-500/30 transition-all shadow-[0_0_15px_rgba(16,185,129,0.3)]"
                  >
                    Sign In
                  </a>
                </div>
